            ...
            <div className={cx('container')}>
                <div className={cx('inner')}>
                    ...
                    <div className={cx('block')}>
                        ...
                        <h2 className={cx('title')}>Kính Sapphire chống trầy</h2>
                        <p>
                            Là loại kính có độ bền cao, chống xước tuyệt đối, thường được sử dụng trong các thương hiệu
                            cao cấp.
                        </p>
                    </div>
                    <div className={cx('block')}>
                        ...
                        <p>
                            Gia công lắp ráp hoàn hảo, giúp bảo vệ đồng hồ một cách tối ưu, chịu được áp lực nước ở cấp
                            độ 5ATM.
                        </p>
                    </div>
                    <div className={cx('block')}>
                        ...
                        <p>
                            Cỗ máy kiểm soát thời gian hoạt động mạnh mẽ và chính xác, thương hiệu nổi danh trên toàn
                            thế giới.
                        </p>
                    </div>
                    <div className={cx('block')}>
